    ...
    if (!$errors) {
        try {
            ...
            if ($result->isSuccess()) {
                ...
                redirect('login.php?registered=1&message=' . urlencode('Account created successfully! You can now use your email and password to login.'));
            } else {
...
<head>
    ...
    <title>Create Account | MerLaws</title>
        ...
        <div class="auth-container">
            <div class="auth-card">
                <div class="auth-header">
                    ...
                    <p>Join MerLaws to access your legal services</p>
                </div>
