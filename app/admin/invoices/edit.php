...
if (!$invoice_service->canEdit($invoice_id)) {
    $_SESSION['error_message'] = 'This invoice cannot be edited in its current status';
...
<head>
    ...
    <title>Edit Invoice #<?php echo e($invoice['invoice_number']); ?> | Med Attorneys Admin</title>
...
<div class="page-header">
    <div class="container">
        ...
        <h1 class="page-title">Edit Invoice #<?php echo e($invoice['invoice_number']); ?></h1>
    </div>
</div>
    ...
    <form method="POST" id="invoice-form">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="case_id" name="case_id">
                        ...
                        <option value="<?php echo $case['id']; ?>" <?php echo $invoice['case_id'] == $case['id'] ? 'selected' : ''; ?>>
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="notes" name="notes" rows="3" 
                              placeholder="Internal notes about this invoice"><?php echo e($invoice['notes']); ?></textarea>
                </div>
                
                <div class="col-md-6">
                    <label for="terms_conditions" class="form-label">Terms & Conditions</label>
                    <textarea class="form-control" id="terms_conditions" name="terms_conditions" rows="4" 
                              placeholder="Payment terms and conditions"><?php echo e($invoice['terms_conditions']); ?></textarea>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" id="payment_instructions" name="payment_instructions" rows="4" 
                              placeholder="Instructions for payment"><?php echo e($invoice['payment_instructions']); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="d-flex justify-content-between">
                <a href="view.php?id=<?php echo $invoice['id']; ?>" class="btn btn-outline-secondary">
...
function addLineItem(item = null) {
    ...
    row.innerHTML = `
        <td>
            <input type="text" class="form-control" name="item_description_${lineItemCount}" 
                   value="${item ? item.description : ''}" placeholder="Item description" required>
        </td>
        <td>
            <input type="number" class="form-control item-qty" name="item_quantity_${lineItemCount}" 
                   value="${item ? item.quantity : 1}" min="0" step="0.01" onchange="calculateLineTotal(this)">
        </td>
        <td>
            <input type="number" class="form-control item-price" name="item_unit_price_${lineItemCount}" 
                   value="${item ? item.unit_price : 0}" min="0" step="0.01" onchange="calculateLineTotal(this)">
        </td>
        <td>
            <input type="number" class="form-control item-tax" name="item_tax_rate_${lineItemCount}" 
                   value="${item ? item.tax_rate : 15}" min="0" max="100" step="0.01" onchange="calculateTotals()">
        </td>
        <td>
            <input type="text" class="form-control item-amount" name="item_amount_${lineItemCount}" 
                   value="${item ? item.amount : '0.00'}" readonly>
        </td>
        <td>
    ...
    if (item) {
        calculateLineTotal(row.querySelector('.item-qty'));
    }
    calculateTotals();
}
